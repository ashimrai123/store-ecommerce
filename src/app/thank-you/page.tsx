...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  let orderUser = order.user as "string" | User;

  const orderUserId = typeof orderUser === "string" ? orderUser : orderUser.id;
  ...
  return (
    <main className="relative lg:min-h-full mt-10">
      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:gap-x-8 lg:py-32 xl:gap-x-24">
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Your order was processed and your assets are availabe to
              ...
              <p className="mt-2 text-base text-muted-foreground">
                ...
                it. So hang tight anad we&apos;ll send you confirmation very
                soon!
              </p>
            )}
            ...
            <div className="mt-16 border-gray-200 py-6 border-t text-right">
              <Link
                href="/products"
